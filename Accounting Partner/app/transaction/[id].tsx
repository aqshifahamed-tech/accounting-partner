...
export default function EditTransactionScreen() {
  ...
  const { getById, updateTransaction, deleteTransaction } = useTransactions();

  const transaction = getById(id as string);
    ...
    >
      ...
      >
        ...
        <Button 
          ...
          variant="destructive" 
          icon={<Feather name="trash-2" size={18} color={colors.destructiveForeground} />}
